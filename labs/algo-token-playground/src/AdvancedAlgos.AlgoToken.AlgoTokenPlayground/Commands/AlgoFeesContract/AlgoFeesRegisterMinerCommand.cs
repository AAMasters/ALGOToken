...
{
    public class IntelliFeesRegisterMinerCommand : EthInvokeTransactionalFunctionCommand
    {
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await intellifees.RegisterMinerAsync(context.ResolveContractReference(MinerAddress));
        }
    }
}
