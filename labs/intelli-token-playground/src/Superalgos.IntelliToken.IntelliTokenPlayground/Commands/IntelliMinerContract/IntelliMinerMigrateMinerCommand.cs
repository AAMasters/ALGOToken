...
{
    public class IntelliMinerMigrateMinerCommand : EthInvokeTransactionalFunctionCommand
    {
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await intelliMiner.MigrateMinerAsync(context.ResolveContractReference(NewMinerAddress));
        }
    }
}
