...
{
    public class IntelliMinerAddCoreTeamCommand : EthInvokeTransactionalFunctionCommand
    {
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await intelliMiner.AddCoreTeamAsync(context.ResolveAccountReference(Account));
        }
    }
}
